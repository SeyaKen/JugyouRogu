        ...
        body: SingleChildScrollView(
            child: Container(
                ...
                child: Column(children: [
                  ...
                  const Center(
                      child: Text(
                    '授業は，本ウェブサイト上で提供するサービス「授業ログ」（以下,「本サービス」といいます。） における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。',
                  )),
                  const SizedBox(
                    height: 10,
                  ),
...
''',
                  ...
                  Center(
                    ...
                    text: TextSpan(
                        ...
                        children: [
                          const TextSpan(
                            text:
                                '本サービスは，ユーザーが利用登録をする際に入力されたメールアドレス・パスワードを保存します。 それと共に入力されたメモ情報や出席・欠席・遅刻回数等の情報も保存します。 また、本サービスでは、利用状況を把握するためのツールとして「Google Analytics」を利用しています。「Google Analytics」から提供されるクッキー（Cookie）を使用していますが、匿名で収集されており、個人を特定するものではありません。 Google Analyticsにより収集されたデータは、Google社の',
                          ),
                          TextSpan(
                  ...
                  Center(
                      child: Column(
                    children: const [
                      Text('本サービスが個人情報を収集・利用する目的は，以下のとおりです。 本サービスサービスの提供・運営のため'),
                    ],
                  )),
                  const SizedBox(
                    height: 10,
...
2.本サービスは，ユーザーから前項の請求を受けてその請求に応じる必要があると判断した場合には，遅滞なく，当該個人情報の訂正等を行うものとします。
